<template>
    <div
      ...
      <span class="video-user">{{data.userId.replace('gx', '屏幕')}}</span>
      ...
      <div class="btns">
        <ul>
          ...
          <li @click="isCamera">
            <img v-if="data.isCamera" class="ali-icon" src="../assets/images/ovideo.png" alt="">
...
export default {
  ...
  methods: {
    ...
    isCamera () {
      this.$parent.$parent.sendMsg('SP|' + this.data.userId)
    }
  }
}
</script>
